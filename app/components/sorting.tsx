...
const Sort = () => {
<button onClick={Sorting}>Search</button>
 };

const Sorting= ({params}:{params:any}) => {
    console.log(params);
  ...
  useEffect(() => {
     const fetchProducts = async () => {
      try {
        const res = await fetch(`https://fakestoreapi.com/products/category/${params.category}?sort=asc`);
